...
public class AirlineController {
  ...
  public List<Airline> getForCountry(@PathVariable final String country) {
    return repository.findAirlineByCountry(country);
  }

  @RequestMapping("/{id}/{favorite}")
  public Airline setFavorite(@PathVariable final Integer id, @PathVariable final boolean favorite) {
